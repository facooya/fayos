...
1. Wait 400ns
    - Using alternate status register. If read status register do clear interrupt signal. Alternate status register read status code is same and not clear interrupt signal.
